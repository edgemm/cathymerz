		...
		protected function drawSliderSize($setting){
			...
			<table>
				<tr>
					...
					<td id="cellWidth" class="disabled">
						Slider Width:
					</td>
					<td id="cellWidthInput" class="disabled">
						<input id="width" name="width" type="text" class="textbox-small" disabled="disabled" value="<?php echo $width?>">
					</td>
					<td id="cellHeight">
						Slider Max Height: 
					</td>

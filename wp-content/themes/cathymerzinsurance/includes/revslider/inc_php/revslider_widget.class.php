...
class RevSlider_Widget extends WP_Widget {
    ...
    public function __construct(){
        ...
        // widget actual processes
     	$widget_ops = array('classname' => 'widget_revslider', 'description' => __('Displays a revolution slider on the page' , 'hbthemes') );
        parent::__construct('rev-slider-widget', __('Revolution Slider','hbthemes'), $widget_ops);
    }
    ...
    public function form($instance) {
		...
		if(empty($arrSliders))
			echo __("No sliders found, Please create a slider", 'hbthemes');
		else{
			$field = "rev_slider";
